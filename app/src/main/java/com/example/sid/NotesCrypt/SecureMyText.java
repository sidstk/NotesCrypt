...
public class SecureMyText {
    ...
    public SecureMyText (Context c,String passPhrase) {
        try {
            ...
            Log.i("password",passPhrase);
            char[] pass =  passPhrase.toCharArray();
            Log.i("char[]",pass.toString());
            ...
            KeySpec keySpec = new PBEKeySpec(pass, salt, iterationCount,
                    256);
            ...
            shp.edit().putString("key",Base64.encodeToString(secret.getEncoded(), Base64.DEFAULT)).apply();
    ...
    public String decrypt(String str,String password) {
        ...
        try {
            ...
            KeySpec keySpec2 = new PBEKeySpec(pass, saltt, iterationCount, 256);
            SecretKey secretKey2 = factory2.generateSecret(keySpec2);
            SecretKey secret2 = new SecretKeySpec(secretKey2.getEncoded(), "AES");
            if(secret2.hashCode() == secret.hashCode())
            {
                Log.i("hashcode", String.valueOf(secret2.hashCode()));
